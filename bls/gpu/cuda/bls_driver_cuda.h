...
// returns -1 except kinet_bls_cuda_available() which returns 0.

#ifndef KINET_BLS_DRIVER_CUDA_H
#define KINET_BLS_DRIVER_CUDA_H
...
int kinet_bls_cuda_available(void);
