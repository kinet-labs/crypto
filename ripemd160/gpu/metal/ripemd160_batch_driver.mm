// Metal driver for batched RIPEMD-160. macOS / iOS only.
// Loads ripemd160_batch.metallib, dispatches `ripemd160_jobs` with one
// thread per input. Byte-equal to ripemd160/cpp/ripemd160.cpp::ripemd160().
...
extern "C" int ripemd160_batch_metal(
    ...
    @autoreleasepool {
        ...
        id<MTLFunction> fn = [lib newFunctionWithName:@"ripemd160_jobs"];
        if (!fn) return -4;
        ...
        std::memcpy(outputs_arena, [outputs_buf contents], n * 20);
    }
    return 0;
}
