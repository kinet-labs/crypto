...
auto features = kinet::crypto::cpu_features();
...
kinet::crypto::set_num_threads(8);

// Or via environment
// export KINET_CRYPTO_THREADS=8
```
...
set(KINET_CRYPTO_METAL OFF)
set(KINET_CRYPTO_CPU ON)

# Enable specific SIMD
set(KINET_CRYPTO_AVX2 ON)
set(KINET_CRYPTO_AVX512 OFF)  # Disable AVX-512
```
...
kinet::crypto::set_use_simd(false);

// Disable multi-threading
kinet::crypto::set_num_threads(1);
```
